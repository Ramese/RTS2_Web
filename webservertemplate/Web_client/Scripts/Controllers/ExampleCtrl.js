...
(function () {
	...
	app.controller('ExampleCtrl', ['$scope', '$window', '$translate', 'CONSTANTS', function ($scope, $window, $translate, CONSTANTS) {

		$scope.$root.title = $translate.instant('TITLE_EXAMPLE') + " | " + CONSTANTS.WEB_NAME;
